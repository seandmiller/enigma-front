...
const Camera = (props) => {
        ...
        messages: [
          {
            role: "user",
            content: [
              { type: "text", text: "I want you to just return the text from the image nothing else." },
              {
                type: "image_url",
                image_url: {
                  "url": img,
    ...
    <div className='camera-wrapper' style={{background:'url(https://wallpaperaccess.com/full/2939800.jpg)'}}> 

         <div className='camera-cont'>
            
            <video id="cap" ref={videoRef} style={{filter: brightness}} allow='camera;microphone' ></video>
