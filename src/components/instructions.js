...
const info = () => {
    ...
    return (<div className='instructions-wrapper'>
        ...
        <li>After that you have the option of using the Plug Board feature, I do not recommend it as adds alot of complexity to the encryption but if you do choose to use it, you will pair 20 letters in pairs of 2 so 10 pairs in total. This will swap letters around as it enters the Virtual Machine</li>
