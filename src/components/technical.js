         ...
         <h4>The Original Design</h4>
          <div className='img-wrapper'>
            ...
            <p> At first glance this blueprint may seem a little bit intimidating but it is actually not. 
                ...
                pathway to the rotors so the output would be 'A'. So in short 'A' =~ 1 =~ 'B' =~ 2 Reflects Back as D if we typed Input as 'D' =~ 2 =~ 'C' =~ 1 Reflects back as 'A' since A is array[1], If you take a look at the diagram you can see the encrypted text links directly with the input. 
                This is how we are able to encrypt and decrypt messages without a encryption and decryption mode.  
            </p>
